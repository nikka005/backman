...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 py-12">
        <div className="max-w-md mx-auto w-full">
          ...
          >
            ...
            {googleClientId ? 'Continue with Google' : 'Google login not configured'}
          </Button>
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative text-center text-white max-w-md">
          ...
          <p className="text-white/80 text-lg">
            Join 55,000+ users who have transformed their Instagram presence with our AI-powered growth engine.
          </p>
          <div className="mt-8 flex items-center justify-center gap-2">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full bg-white/30 border-2 border-white/50"></div>
              ))}
            </div>
            <span className="text-white/80 text-sm">+12K joined this month</span>
          </div>
        </div>
      </div>
    </div>
