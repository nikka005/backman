...
const SignupPage = () => {
  ...
  const benefits = [
    '1,000+ guaranteed followers monthly',
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Visual */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-gray-900 to-gray-800 p-12 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-50"></div>
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-orange-500/20 to-pink-500/20 rounded-full blur-3xl"></div>
        ...
        <div className="relative text-white max-w-md">
          <Link to="/" className="flex items-center gap-2 mb-12">
            ...
            <span className="text-2xl font-bold">Adverlyx</span>
          </Link>
          
          <h2 className="text-3xl font-bold mb-6">
            Join 55,000+ users growing on Instagram
          </h2>
          ...
          <div className="mt-12 p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
            ...
            <p className="text-gray-300 italic">
              "Adverlyx helped me gain 40K real followers in just 3 months. The AI targeting is incredibly accurate!"
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 py-12 bg-white">
        <div className="max-w-md mx-auto w-full">
          ...
          <Link to="/" className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="text-2xl font-bold text-gray-900">Adverlyx</span>
          </Link>
          ...
          <Button 
            variant="outline" 
            className="w-full rounded-full py-6 border-gray-300 hover:bg-gray-50"
          ...
          >
            ...
            {googleClientId ? 'Continue with Google' : 'Google sign-up not configured'}
          </Button>
