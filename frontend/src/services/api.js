...
export const instagramAPI = {
  ...
  syncData: () => api.post('/instagram/sync'),
  // Real data endpoints (OAuth)
...
export const adminAPI = {
  ...
  changePlan: (subscriptionId, newPlan) => api.post(`/admin/subscriptions/${subscriptionId}/change-plan`, { new_plan: newPlan }),
  getPayments: (params) => api.get('/admin/payments', { params }),
  processRefund: (paymentId, data) => api.post(`/admin/payments/${paymentId}/refund`, data),
