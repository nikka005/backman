...
const MobileNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 lg:hidden" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }} data-testid="mobile-nav">
